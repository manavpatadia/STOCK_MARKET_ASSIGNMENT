...
//1.1
val input = sc.textFile("/home/manav/Desktop/stock_market_case_study/input/stock_market.csv").map(line => line.split(","))
...
output_1_1.map(line => line.productIterator.mkString("\t")).repartition(1).saveAsTextFile("/home/manav/Desktop/stock_market_case_study/spark/output_1_1")

//1.2
val stock_filter = input.filter(x => x(0).toString == "GEOMETRIC")
val output_1_2 = stock_filter.map(x => {(x(0).toString, x(2).toDouble, x(3).toDouble, x(4).toDouble, x(5).toDouble)})
output_1_2.map(line => line.productIterator.mkString("\t")).repartition(1).saveAsTextFile("/home/manav/Desktop/stock_market_case_study/spark/output_1_2")

//1.3
val output_1_3 = sc.parallelize(Seq(output_1_2.count(),""))
output_1_3.repartition(1).saveAsTextFile("/home/manav/Desktop/stock_market_case_study/spark/output_1_3")
...
output_2_1.map(line => line.productIterator.mkString("\t")).repartition(1).saveAsTextFile("/home/manav/Desktop/stock_market_case_study/spark/output_2_1")
...
output_2_2.map(line => line.productIterator.mkString("\t")).repartition(1).saveAsTextFile("/home/manav/Desktop/stock_market_case_study/spark/output_2_2")
...
output_3_1.map(line => line.productIterator.mkString("\t")).repartition(1).saveAsTextFile("/home/manav/Desktop/stock_market_case_study/spark/output_3_1")
...
output_3_2.map(line => line.productIterator.mkString("\t")).repartition(1).saveAsTextFile("/home/manav/Desktop/stock_market_case_study/spark/output_3_2")
...
output_3_3.map(line => line.productIterator.mkString("\t")).repartition(1).saveAsTextFile("/home/manav/Desktop/stock_market_case_study/spark/output_3_3")
