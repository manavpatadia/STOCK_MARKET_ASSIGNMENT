...
STOCK = LOAD '/home/manav/Documents/STOCK_MARKET_ASSIGNMENT/DATA/STOCK_MARKET_DS.csv' USING PigStorage(',') AS ( SYMBOL:CHARARRAY, SERIES:CHARARRAY, OPEN:DOUBLE, HIGH:DOUBLE, LOW:DOUBLE, CLOSE:DOUBLE, LAST:DOUBLE, PREVCLOSE:DOUBLE, TOTTRDQTY:DOUBLE, TOTTRDVAL:DOUBLE, TIMESTAMP:CHARARRAY, TOTALTRADES:INT, ISIN:CHARARRAY);
...
STORE FILTER_DATA INTO '/home/manav/Documents/STOCK_MARKET_ASSIGNMENT/PIG/OUTPUT/1_1/' USING PigStorage (',');

--1.2
IMP_COL = FOREACH FILTER_DATA GENERATE SYMBOL, OPEN, HIGH, LOW, CLOSE;
STORE IMP_COL INTO '/home/manav/Documents/STOCK_MARKET_ASSIGNMENT/PIG/OUTPUT/1_2/' USING PigStorage (',');

--1.3
GROUP_ALL = GROUP IMP_COL ALL;
COUNT_FILTERED= FOREACH GROUP_ALL GENERATE COUNT(IMP_COL.SYMBOL) AS (COUNT_GEO:LONG);
STORE COUNT_FILTERED INTO '/home/manav/Documents/STOCK_MARKET_ASSIGNMENT/PIG/OUTPUT/1_3/' USING PigStorage (',');
...
STORE FILTER_DATA INTO '/home/manav/Documents/STOCK_MARKET_ASSIGNMENT/PIG/OUTPUT/2_1/' USING PigStorage (',');
--2.2
...
STORE SORT_STATS INTO '/home/manav/Documents/STOCK_MARKET_ASSIGNMENT/PIG/OUTPUT/2_2/' USING PigStorage (',');
...
STORE LIMIT_DATA INTO '/home/manav/Documents/STOCK_MARKET_ASSIGNMENT/PIG/OUTPUT/3_1/' USING PigStorage (',');

--3.2
ITSTOCK = FILTER FILTER_DATA BY SYMBOL IN ('HCLTECH', 'NIITTECH', 'TATAELXSI','TCS', 'INFY', 'WIPRO', 'DATAMATICS','TECHM','MINDTREE', 'OFSS');
STORE ITSTOCK INTO '/home/manav/Documents/STOCK_MARKET_ASSIGNMENT/PIG/OUTPUT/3_2/' USING PigStorage (',');
...
STORE PEARSONCORITSTOCK_SORT INTO '/home/manav/Documents/STOCK_MARKET_ASSIGNMENT/PIG/OUTPUT/3_3/' USING PigStorage (',');
